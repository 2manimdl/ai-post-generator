        ...
        <div className="space-y-6">
            ...
            <div className="pt-4 border-t space-y-4">
                ...
                <div className="flex justify-between items-center mt-4">
                    <label className="text-[10px] font-bold uppercase">Tanggal</label>
                </div>
                <input
                    value={content.date}
                    onChange={e => setContent({ ...content, date: e.target.value.toUpperCase() })}
                    className="w-full p-3 border rounded-xl font-bold text-sm"
                    placeholder="Kosongkan jika tidak ingin ada tanggal"
                />
            </div>
